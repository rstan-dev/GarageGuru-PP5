            ...
            <div className={styles.CardBlock}>
                ...
                <Card className={styles.StatusCard}>
                    ...
                    <div className={`row ${styles['StatusBlock']}`}>
                        ...
                        <div className="col-md-4">
                            <div
                                className={`card ${styles.CardPointer} ${selectedStatus === 'Invoiced' ? styles['InvoicedBorder'] : ''}`}
                                onClick={() => {setQuery("Invoiced"); setSelectedStatus("Invoiced");}}>
                                    <div className={`card-body text-center ${styles.StatusIconContainer}`}>
                                    <i className={`fa-solid fa-hourglass-half ${styles['InvoicedIcon']}`}></i>
                                    <div className={styles.Title}>Invoiced</div>
                                    <div className={styles.Title}>{statusCounts.Invoiced || '0'}</div>
                                </div>
                            </div>
                        ...
                        <div className="col-md-4">
                            <div
                                className={`card ${styles.CardPointer} ${selectedStatus === 'Paid' ? styles['PaidBorder'] : ''}`}
                                onClick={() => {setQuery("Paid"); setSelectedStatus("Paid");}}>
                                <div className={`card-body text-center ${styles.StatusIconContainer}`}>
                                    <i className={`fa-solid fa-hourglass-half ${styles['PaidIcon']}`}></i>
                                    <div className={styles.Title}>Paid</div>
                                    <div className={styles.Title}>{statusCounts.Paid || '0'}</div>
                                </div>
                            </div>
