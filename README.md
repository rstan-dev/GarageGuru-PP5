...
* [Back to Contents](#contents)
  ...
  ### User Stories
  All epics, user stories with their acceptance criteria and tasks can be viewed on the YooMoov [GitHub Project board](https://github.com/users/rstan-dev/projects/8/views/2)
...
- There were 29 User Stories Created including:
  ...
  * [Back to Contents](#contents)
  ...
  I created the logo in Canva using royalty-free images
  ...
  <details>
    <summary>Click to View More Canva Images</summary>
