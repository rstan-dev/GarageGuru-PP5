...
class Invoice(models.Model):
    ...
    customer_phone = models.CharField(max_length=100,
                             verbose_name="Enter customer's phone number", blank=True)
    ...
    invoice_status = models.CharField(max_length=75, choices=STATUS_CHOICES, default='Pending')

    class Meta:
        ordering = ['-created_at']

    def __str__(self):
        return f'{self.id} {self.customer_firstname} {self.customer_lastname}'
